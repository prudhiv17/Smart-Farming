...
with open('C:/Users/Admin/Documents/Trial/models/decision_tree_model.pkl', 'rb') as model_file:
    model = pickle.load(model_file)

with open('C:/Users/Admin/Documents/Trial/models/label_encoder.pkl', 'rb') as le_file:
